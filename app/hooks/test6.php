...
class AccountPlanner {
    ...
    public function __construct() {
        ...
        $this->api_key = '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';
    ...
    public function account_filter_by_ajax(){
        if (isset($_POST['external_company']) && ($_POST['external_company'] !=="")) {
            ...
            try {
                ...
                $fourth_response = $this->chatgpt_send_message($open_ai, $question_4, "");
    ...
    public function chatgpt_send_message(OpenAi &$open_ai, string &$question, string &$last_message) {
        try {
            // Send message to the chat model
            return json_decode($open_ai->chat([
                'model' => 'gpt-3.5-turbo',
                'messages' => [
                    [
                        "role" => "system",
