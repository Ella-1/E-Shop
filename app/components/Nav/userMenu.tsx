...
import { signOut } from 'next-auth/react'
 ...
 export const UserMenu = () => {
   ...
   return (
     <>
        <div className='rela tive z-30'>
            <div onClick={toggleOpen} className='p-2 border-[1px]  border-slate-400 flex flex-grow item-center gap-1 rounded-full cursor-pointer hover:shadow-md text-slate-700 hover:duration-300'>
                <Avater />
                <AiFillCaretDown />
            </div>
            {isOpen && (
