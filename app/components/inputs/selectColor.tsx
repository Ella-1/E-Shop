...
export const SelectColor: React.FC<SelectColorProps> = ({
  ...
  return <div className="grid grid-cols-1 md:grid-cols-2 overflow-y-auto border-b-[1.2px] items-center p-2  border-slate-200">
...
{file && (
      <div className="flex flex-row gap-2 text-sm col-span-2 item-center justify-between">
        <p>{file?.name}</p>
